...
export class ClientService {
  ...
  public GetFile(notification: NotificationModel, subscriptionKey: string, jsonOrXml: boolean) {
  ...
  public getNotifications() {
    return this.httpClient.get<NotificationModel[]>(this.baseUrl + 'notifications');
  }
